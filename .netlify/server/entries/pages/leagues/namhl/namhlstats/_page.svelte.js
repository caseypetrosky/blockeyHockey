...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<div class="container py-4 mx-auto text-white tabs " data-svelte-h="svelte-ty7mn0"><a href="/leagues/namhl" class="tab tab-bordered text-2xl">League Info</a> <a href="/leagues/namhl/rosters" class="tab tab-bordered text-2xl ">Team Rosters</a> <a href="/leagues/namhl/standings" class="tab tab-bordered text-2xl">Standings</a> <a href="/leagues/namhl/namhlstats" class="tab tab-bordered tab-active text-2xl">Stats Leaderboard</a></div> <div class="container mx-auto text-white">${validate_component(Tabs, "Tabs").$$render($$result, { style: "pill", class: "mt-4 text-white " }, {}, {
    default: () => {
