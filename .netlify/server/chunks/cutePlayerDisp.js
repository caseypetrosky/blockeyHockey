...
const CutePlayerDisp = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { player } = $$props;
  let goals = 0;
  let assists = 0;
  let gamesPlayed = 0;
