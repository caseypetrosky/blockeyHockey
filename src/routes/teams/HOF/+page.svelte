...
<div class="container mx-auto mt-10">
    ...
    <div class="inline-flex">
        <img src="/bhl.png" alt="team logo" class="h-44 w-auto mr-4">
        <div>
    ...
    <h2 class="text-2xl mt-4">Hall OF Fame Players</h2>
    <hr class=" border-2 w-1/4 border-yellow-400" >
            <div class="grid gap-4 mt-4">
            {#if teamPlayers.length > 0}
                {#each teamPlayers as player}
                    <a href="/stats/{player.uuid}">
                        <div class="flex items-center space-x-4 p-4 border-2 border-yellow-400 rounded-lg">
